...
query_so <- JackStraw(object = query_so, dims = 50)
query_so <- ScoreJackStraw(object = query_so, dims = 1:50)

pc_pvals <- query_so@reductions$pca@jackstraw$overall.p.values[,2]
